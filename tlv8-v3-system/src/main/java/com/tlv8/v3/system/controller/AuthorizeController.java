...
import com.tlv8.v3.system.service.ISaOpAuthorizeService;
import com.tlv8.v3.system.service.ISaOpOrgService;
import com.tlv8.v3.system.service.ISaOpRoleService;
...
public class AuthorizeController {
	...
	public Object removeAuthorizes(@RequestBody Map<String, String> param) {
		...
		for (String auid : aus) {
			...
			if (authorize != null) {
				if (("PSN01@ORG01".equals(authorize.getSorgid()) || authorize.getSorgid().contains("PSN01"))
						&& "RL01".equals(authorize.getSauthorizeroleid())) {
					// 超管权限不能删除
					continue;
				}
