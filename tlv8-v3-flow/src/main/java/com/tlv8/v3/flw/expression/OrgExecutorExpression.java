package com.tlv8.v3.flw.expression;
...
import com.tlv8.v3.flw.helper.ExecutorGroupFilter;
...
public class OrgExecutorExpression {
	...
	public static String getOrgUnitHasActivity(String process, String activity, String inOrg, String personMember) {
		...
		try {
			List<Map<String, String>> list = com.tlv8.v3.common.db.DBUtils.execQueryforList("system", sql, true);
